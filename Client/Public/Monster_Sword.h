...
class CMonster_Sword final : public CMonster
{
private:
	CMonster_Sword(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMonster_Sword(const CMonster_Sword& rhs);
	virtual ~CMonster_Sword() = default;
...
private:
	...
	CCollider*				m_pColliderCom_Weapon = { nullptr };
...
public:
	static CMonster_Sword* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
